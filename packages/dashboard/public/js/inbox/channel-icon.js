// inbox/channel-icon.js -- channel SVG icons and metadata
...
const ICONS = {
  ...
  'fb-messenger': "<svg width='14' height='14' viewBox='0 0 24 24' fill='currentColor'><path d='M12 0C5.373 0 0 4.975 0 11.111c0 3.497 1.745 6.616 4.472 8.652V24l4.086-2.242c1.09.301 2.246.464 3.442.464 6.627 0 12-4.974 12-11.111C24 4.975 18.627 0 12 0zm1.193 14.963l-3.056-3.259-5.963 3.259L10.986 9l3.13 3.259L20.014 9l-6.821 5.963z'/></svg>",
  ...
  'loom-a2a': "<svg width='14' height='14' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2'><circle cx='12' cy='12' r='3'/><path d='M12 2v3M12 19v3M2 12h3M19 12h3M5.636 5.636l2.122 2.122M16.242 16.242l2.122 2.122M5.636 18.364l2.122-2.122M16.242 7.758l2.122-2.122'/></svg>",
};
...
export function channelIcon(channel, colored) {
  var icon = ICONS[channel] || ICONS.sms;
  if (!colored) return icon;
  var color = CHANNEL_COLORS[channel] || '#888';
